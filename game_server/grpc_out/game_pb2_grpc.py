...
class GameStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetPlayersShots = channel.unary_stream(
        ...
        request_serializer=game__server_dot_grpc__out_dot_game__pb2.Nothing.SerializeToString,
        response_deserializer=game__server_dot_grpc__out_dot_game__pb2.Id.FromString,
        )
...
def add_GameServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'GetPlayersShots': grpc.unary_stream_rpc_method_handler(
          ...
          request_deserializer=game__server_dot_grpc__out_dot_game__pb2.Nothing.FromString,
          response_serializer=game__server_dot_grpc__out_dot_game__pb2.Id.SerializeToString,
      ),
