...
from game_server.grpc_out import game_pb2 as game__server_dot_grpc__out_dot_game__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in game_server/grpc_out/game_pb2_grpc.py depends on'
...
class GameStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Connect = channel.unary_unary(
                '/grpc.Game/Connect',
                request_serializer=game__server_dot_grpc__out_dot_game__pb2.PlayerInformation.SerializeToString,
                response_deserializer=game__server_dot_grpc__out_dot_game__pb2.Position.FromString,
                _registered_method=True)
        self.GetMap = channel.unary_unary(
                '/grpc.Game/GetMap',
                request_serializer=game__server_dot_grpc__out_dot_game__pb2.Nothing.SerializeToString,
                response_deserializer=game__server_dot_grpc__out_dot_game__pb2.Map.FromString,
                _registered_method=True)
        self.GetPlayersMovements = channel.unary_stream(
                ...
                response_deserializer=game__server_dot_grpc__out_dot_game__pb2.PlayerMovement.FromString,
                _registered_method=True)
        ...
        self.GetKills = channel.unary_stream(
                '/grpc.Game/GetKills',
                request_serializer=game__server_dot_grpc__out_dot_game__pb2.Id.SerializeToString,
                response_deserializer=game__server_dot_grpc__out_dot_game__pb2.KillInformation.FromString,
                _registered_method=True)
...
def add_GameServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Connect': grpc.unary_unary_rpc_method_handler(
                    servicer.Connect,
                    request_deserializer=game__server_dot_grpc__out_dot_game__pb2.PlayerInformation.FromString,
                    response_serializer=game__server_dot_grpc__out_dot_game__pb2.Position.SerializeToString,
            ),
            'GetMap': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=game__server_dot_grpc__out_dot_game__pb2.Map.SerializeToString,
            ),
            'GetPlayersMovements': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=game__server_dot_grpc__out_dot_game__pb2.PlayerMovement.SerializeToString,
            ),
            ...
            'GetKills': grpc.unary_stream_rpc_method_handler(
                    servicer.GetKills,
                    request_deserializer=game__server_dot_grpc__out_dot_game__pb2.Id.FromString,
                    response_serializer=game__server_dot_grpc__out_dot_game__pb2.KillInformation.SerializeToString,
            ),
...
class Game(object):
    ...
    def Connect(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/grpc.Game/Connect',
            game__server_dot_grpc__out_dot_game__pb2.PlayerInformation.SerializeToString,
            game__server_dot_grpc__out_dot_game__pb2.Position.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetMap(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/grpc.Game/GetMap',
            game__server_dot_grpc__out_dot_game__pb2.Nothing.SerializeToString,
            game__server_dot_grpc__out_dot_game__pb2.Map.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetPlayersMovements(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/grpc.Game/GetPlayersMovements',
            game__server_dot_grpc__out_dot_game__pb2.Id.SerializeToString,
            game__server_dot_grpc__out_dot_game__pb2.PlayerMovement.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetPlayersTurns(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            '/grpc.Game/GetPlayersTurns',
            game__server_dot_grpc__out_dot_game__pb2.Id.SerializeToString,
            game__server_dot_grpc__out_dot_game__pb2.PlayerTurn.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetAllBullets(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            '/grpc.Game/GetAllBullets',
            game__server_dot_grpc__out_dot_game__pb2.Nothing.SerializeToString,
            game__server_dot_grpc__out_dot_game__pb2.Bullets.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetAllPlayers(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            '/grpc.Game/GetAllPlayers',
            game__server_dot_grpc__out_dot_game__pb2.Nothing.SerializeToString,
            game__server_dot_grpc__out_dot_game__pb2.OtherPlayerInformation.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetPlayersHealthsChanging(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            '/grpc.Game/GetPlayersHealthsChanging',
            game__server_dot_grpc__out_dot_game__pb2.Id.SerializeToString,
            game__server_dot_grpc__out_dot_game__pb2.HealthsChanging.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetPlayerName(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/grpc.Game/GetPlayerName',
            game__server_dot_grpc__out_dot_game__pb2.Id.SerializeToString,
            game__server_dot_grpc__out_dot_game__pb2.Name.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetKills(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            '/grpc.Game/GetKills',
            game__server_dot_grpc__out_dot_game__pb2.Id.SerializeToString,
            game__server_dot_grpc__out_dot_game__pb2.KillInformation.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Move(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/grpc.Game/Move',
            game__server_dot_grpc__out_dot_game__pb2.Id.SerializeToString,
            game__server_dot_grpc__out_dot_game__pb2.Nothing.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Turn(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/grpc.Game/Turn',
            game__server_dot_grpc__out_dot_game__pb2.TurnMessage.SerializeToString,
            game__server_dot_grpc__out_dot_game__pb2.Nothing.FromString,
            options,
            channel_credentials,
            insecure,
